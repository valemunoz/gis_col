...
$pais=getPaises(" and code ilike '".$_SESSION['us_pais']."'");

$_SESSION['us_nom_pais']=$pais[0][1];
...
<head>
   ...
   <link rel="shortcut icon" href="images/pin.png">
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.php"> 
                <img src="images/logo_geo.png" id="img_header"></a>
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-cog"></i><span> Filtro Puntos</span></a>
                        ...
                        <li class="nav-header hidden-md">Opciones Mapa</li> 
                         <li class="accordion">
                        	<a href="#" id="controles"><i class="glyphicon glyphicon-th"></i><span>Cluster</span></a>
                        	<ul class="nav nav-pills nav-stacked">
                        		<li><span class="txt_ejemplo">Seleccione una de las categorias</span></li>
                        		<li><h5>Mis Categorias <br>
                            	    	<select class=input_form id=mis_cat name=mis_cat>					
																		</Select></h5></li>
														<li> <button type="button" class="btn btn-default" data-dismiss="modal" onclick="clusterData();">Cluster!</button> 	    </li>
																		<script>
																			loadCateg();
																			</Script>
               						</ul>
...
<div class="row" >
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://www.geodoomla.com" target="_blank">Geodoomla.com</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="http://www.colombiamap.co">Colombiamap.co</a></p>
    </footer>
...
<?php
if(strtolower($pais[0][0])!="chi")
{
	?>
	<script>
		moverCentro(<?=$pais[0][2]?>,<?=$pais[0][3]?>,8);
	</script>
	<?php
}
